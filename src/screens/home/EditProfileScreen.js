...
import { Camera, Profile, Mobile, Message2, Calendar, CalendarEdit, ArrowLeft2, Edit2, Messages3 } from 'iconsax-react-native';
        ...
        <View className="container px-8 items-center">
          ...
          <KeyboardAvoidingView className="mt-3 w-full h-100" behavior={Platform.OS === "ios" ? "padding" : ""}>
            <ScrollView className="mt-4">
              ...
              <View style={styles.action}>
                <Messages3 size="28" color="#697689" />
                <TextInput
                  value={user.email}
                  placeholder="Email"
                  placeholderTextColor="#666666"
